#copyright Yacine Jernite, license assumed to be Apache-2 as HuggingFace work
#copyright Andrew Olney, licensed as Apache-2
...
#NOTE: USES CUDA:0 FOR MOST EVERYTHING BY DEFAULT!
...
def qa_s2s_generate(
    ...
    print("qa_s2s_generate device: " + str(device) )
